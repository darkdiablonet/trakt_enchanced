 ...
 */
export async function markEpisodeWatched(episode, headers) {
  const body = {
    shows: [{
  ...
  const result = await httpPostJson('https://api.trakt.tv/sync/history', body, headers);
...
export async function markMovieWatched(movie, headers) {
  const body = {
    movies: [{

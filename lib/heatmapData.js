...
export async function generateRealHeatmapData(year, type = 'all') {
  try {
    ...
    try {
      ...
      // Parcourir les films et compter ceux de l'année demandée (moviesRows au lieu de movies)
      ...
      logger.debug(`Heatmap: Ajouté ${history.moviesRows?.length || 0} films depuis l'historique`);
    } catch (err) {
